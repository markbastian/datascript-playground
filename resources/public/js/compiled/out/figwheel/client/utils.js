...
return (new CustomEvent(event_name,(function (){var obj31555 = {"detail":data};
return obj31555;
})()));
} else {
...
var f = (function (){var pred__31562 = cljs.core._EQ_;
var expr__31563 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31562.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31563))){
return ((function (pred__31562,expr__31563){
return (function (p1__31556_SHARP_){
return console.warn(p1__31556_SHARP_);
});
;})(pred__31562,expr__31563))
} else {
if(cljs.core.truth_(pred__31562.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31563))){
return ((function (pred__31562,expr__31563){
return (function (p1__31557_SHARP_){
return console.debug(p1__31557_SHARP_);
});
;})(pred__31562,expr__31563))
} else {
if(cljs.core.truth_(pred__31562.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31563))){
return ((function (pred__31562,expr__31563){
return (function (p1__31558_SHARP_){
return console.error(p1__31558_SHARP_);
});
;})(pred__31562,expr__31563))
} else {
return ((function (pred__31562,expr__31563){
return (function (p1__31559_SHARP_){
return console.log(p1__31559_SHARP_);
});
;})(pred__31562,expr__31563))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31566){
...
var opts = map__31567__$1;
var eval_fn = cljs.core.get.call(null,map__31567__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31569_SHARP_);
});})(new_def))
);
...
return (function (p__31570){
var vec__31571 = p__31570;
var ky = cljs.core.nth.call(null,vec__31571,(0),null);
var v = cljs.core.nth.call(null,vec__31571,(1),null);
...
}catch (e31576){if((e31576 instanceof Error)){
var e = e31576;
return not_found;
} else {
throw e31576;
...
//# sourceMappingURL=utils.js.map?rel=1533186709410
