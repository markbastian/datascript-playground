...
var G__24908 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24908;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24909 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24909,ch);
...
if(("\\" === ch__$1)){
var ch_24910__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24910__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24910__$2);
} else {
}
...
var vec__24919 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24919,(0),null);
var start_column = cljs.core.nth.call(null,vec__24919,(1),null);
...
var G__24922 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24922;
continue;
}
}
...
var _STAR_read_delim_STAR_24923 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_24923;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24924 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24924,(0),null);
var start_column = cljs.core.nth.call(null,vec__24924,(1),null);
...
var vec__24927 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24927,(0),null);
var end_column = cljs.core.nth.call(null,vec__24927,(1),null);
...
var vec__24930 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24930,(0),null);
var start_column = cljs.core.nth.call(null,vec__24930,(1),null);
...
var vec__24933 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24933,(0),null);
var end_column = cljs.core.nth.call(null,vec__24933,(1),null);
...
var vec__24936 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24936,(0),null);
var start_column = cljs.core.nth.call(null,vec__24936,(1),null);
...
var vec__24939 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24939,(0),null);
var end_column = cljs.core.nth.call(null,vec__24939,(1),null);
...
var sb = (function (){var G__24942 = (new goog.string.StringBuffer());
G__24942.append(initch);
...
var G__24944 = (function (){var G__24943 = sb;
G__24943.append(ch);

return G__24943;
})();
var G__24945 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24944;
ch = G__24945;
continue;
}
...
switch (G__24948) {
case "\\":
var G__24952 = (function (){var G__24949 = sb;
G__24949.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24949;
})();
var G__24953 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24952;
ch = G__24953;
continue;
...
break;
default:
var G__24954 = (function (){var G__24950 = sb;
G__24950.append(ch);

return G__24950;
})();
var G__24955 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24954;
ch = G__24955;
continue;
...
var vec__24956 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24956,(0),null);
var end_column = cljs.core.nth.call(null,vec__24956,(1),null);
...
var vec__24959 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24959,(0),null);
var column = cljs.core.nth.call(null,vec__24959,(1),null);
...
var vec__24964 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24964,(0),null);
var column = cljs.core.nth.call(null,vec__24964,(1),null);
...
var vec__24969 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24969,(0),null);
var column = cljs.core.nth.call(null,vec__24969,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24974 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24974,(0),null);
var start_column = cljs.core.nth.call(null,vec__24974,(1),null);
...
var vec__24977 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24977,(0),null);
var end_column = cljs.core.nth.call(null,vec__24977,(1),null);
...
var G__24980 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24980,true,null,opts,pending_forms);
...
var G__24981 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24981)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24981)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24981)){
...
var _STAR_suppress_read_STAR_24982 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24982;
}});
...
var G__24983 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24983,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24983,rdr,first_line);
...
var G__24987 = matched;
var G__24988 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24987;
finished = G__24988;
continue;
} else {
...
var _STAR_suppress_read_STAR_24989 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24989;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env24990 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24991 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24991,"(");
...
var G__24992 = (i + (1));
var G__24993 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env24990;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24994 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24994);
...
var G__24995 = cljs.core.next.call(null,s__$1);
var G__24996 = ret;
s__$1 = G__24995;
r = G__24996;
continue;
...
var G__24997 = cljs.core.next.call(null,s);
var G__24998 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24997;
key_vals = G__24998;
continue;
} else {
...
var gensym_env25002 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env25002;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__25003 = token;
var G__25003__$1 = (((G__25003 == null))?null:cljs.core.subs.call(null,G__25003,(1)));
var G__25003__$2 = (((G__25003__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__25003__$1));
var G__25003__$3 = (((G__25003__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__25003__$2));
var G__25003__$4 = (((G__25003__$3 == null))?null:cljs.core.symbol.call(null,G__25003__$3));
if((G__25003__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__25003__$4);
}
})():(function (){var G__25004 = token;
var G__25004__$1 = (((G__25004 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__25004));
if((G__25004__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__25004__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e25011){if((e25011 instanceof Error)){
var e = e25011;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__25015,reader){
var map__25016 = p__25015;
var map__25016__$1 = ((((!((map__25016 == null)))?(((((map__25016.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25016.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25016):map__25016);
var opts = map__25016__$1;
var eof = cljs.core.get.call(null,map__25016__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq25022){
var G__25023 = cljs.core.first.call(null,seq25022);
var seq25022__$1 = cljs.core.next.call(null,seq25022);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25023,seq25022__$1);
});


//# sourceMappingURL=reader.js.map?rel=1533186703818
