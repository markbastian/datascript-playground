...
if((i < len)){
var k = (ks[i]);
var G__24725 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__24726 = (i + (1));
m = G__24725;
i = G__24726;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__24728 = c;
var G__24728__$1 = (((G__24728 == null))?null:G__24728.prototype);
if((G__24728__$1 == null)){
return null;
} else {
return (G__24728__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__24730 = c;
var G__24730__$1 = (((G__24730 == null))?null:G__24730.prototype);
if((G__24730__$1 == null)){
return null;
} else {
return (G__24730__$1["render"]);
}
})() == null))));
});
...
while (G__24734__i < G__24734__a.length) {G__24734__a[G__24734__i] = arguments[G__24734__i + 0]; ++G__24734__i;}
  args = new cljs.core.IndexedSeq(G__24734__a,0,null);
} 
...
var _STAR_current_component_STAR_24737 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_24737;
}});
...
return ((function (G__24738,G__24738__$1){
...
var c = this;
var G__24743_24745 = (c["cljsRatom"]);
if((G__24743_24745 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__24743_24745);
}
...
var renders_24747 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_24748 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_24747));
if((cljs.core.count.call(null,renders_24747) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_24747))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_24748)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_24748))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__24746 = name;
switch (G__24746) {
case "":
...
var G__24750 = o;
(G__24750[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__24751 = fiber;
var G__24751__$1 = (((G__24751 == null))?null:(G__24751["type"]));
if((G__24751__$1 == null)){
return null;
} else {
return (G__24751__$1["displayName"]);
}
})();
var parent = (function (){var G__24752 = fiber;
if((G__24752 == null)){
return null;
} else {
return (G__24752["return"]);
}
})();
var path = (function (){var G__24753 = parent;
var G__24753__$1 = (((G__24753 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__24753));
if((G__24753__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24753__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__24755 = c;
if((G__24755 == null)){
return null;
} else {
return (G__24755["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__24756._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__24758 = c;
if((G__24758 == null)){
return null;
} else {
return (G__24758["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__24760 = c;
if((G__24760 == null)){
return null;
} else {
return G__24760._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__24762 = instance;
if((G__24762 == null)){
return null;
} else {
return (G__24762["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__24763 = instance;
if((G__24763 == null)){
return null;
} else {
return G__24763._currentElement;
}
}
})();
var name = (function (){var G__24764 = elem;
var G__24764__$1 = (((G__24764 == null))?null:(G__24764["type"]));
if((G__24764__$1 == null)){
return null;
} else {
return (G__24764__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__24766 = elem;
if((G__24766 == null)){
return null;
} else {
return (G__24766["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__24767._owner;
}
}
})();
var path = (function (){var G__24768 = owner;
var G__24768__$1 = (((G__24768 == null))?null:reagent.impl.component.component_path.call(null,G__24768));
if((G__24768__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24768__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__24769 = c;
var G__24769__$1 = (((G__24769 == null))?null:G__24769.constructor);
if((G__24769__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__24769__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1533186703160
